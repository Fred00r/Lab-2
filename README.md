...
1. Тест:
    - **Input**:
        ```
        Введите размеры массива N и M: 3 3
        Введите элементы массива (true/false): 
        true false true false true false true false true
        ```

    - **Output**:
        ```
        Строка с максимальным количеством последовательных true: [false, true, false]
        Длина этой последовательности: 1
        Элементы массива в виде матрицы:
        -+-
        +-+
        +-+
        Количество островков (групп соседних true): 3
        Массив симметричен относительно главной диагонали: false
        Минимальное количество изменений для достижения симметрии: 2
        ```
